								...
								<div id="sales_collapse" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
									<div class="panel-body">
										...
										<div class="form-group" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">	
                                                                          ...
                                                                          <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">
                                                                                  <?php echo form_label(lang('config_require_customer_for_sale_by_payment').':', 'require_customer_for_sale_by_payment',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                                                                                  <div class="col-sm-9 col-md-9 col-lg-10">
                                                                                  <?php echo form_checkbox(array(
                                                                                          'name'=>'require_customer_for_sale_by_payment',
                                                                                          'id'=>'require_customer_for_sale_by_payment',
                                                                                          'value'=>'1',
                                                                                          'checked'=>$this->config->item('require_customer_for_sale_by_payment')));?>
                                                                                          <label for="require_customer_for_sale_by_payment"><span></span></label>
                                                                                  </div>
                                                                          </div>

                                                                          <div class="form-group" data-keyword="<?php echo H(lang('config_keyword_sales')) ?>">
                                                                                  <?php echo form_label(lang('config_payment_type_to_require_customer').':', 'require_customer_for_sale_by_payment_type',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label ')); ?>
                                                                                  <div class="col-sm-9 col-md-9 col-lg-10">
                                                                                  <?php
                                                                                          $require_customer_payment_options = array('' => lang('common_none'));

                                                                                          foreach($this->Sale->get_payment_options_with_language_keys() as $payment_label => $payment_key)
                                                                                          {
                                                                                                  $require_customer_payment_options[$payment_key] = $payment_label;
                                                                                          }

                                                                                          echo form_dropdown('require_customer_for_sale_by_payment_type', $require_customer_payment_options, $this->config->item('require_customer_for_sale_by_payment_type'), 'class="form-control" id="require_customer_for_sale_by_payment_type"'.($this->config->item('require_customer_for_sale_by_payment') ? '' : ' disabled'));
                                                                                  ?>
                                                                                  </div>
                                                                          </div>
...
{	
	...
	$("#add_tier").click(function()
	{
        ...
        function toggleRequireCustomerPaymentType()
        {
                var enabled = $('#require_customer_for_sale_by_payment').is(':checked');
                $('#require_customer_for_sale_by_payment_type').prop('disabled', !enabled);
        }

			toggleRequireCustomerPaymentType();
			$('#require_customer_for_sale_by_payment').change(toggleRequireCustomerPaymentType);
			$('#config_form').submit(function()
			{
				$('#require_customer_for_sale_by_payment_type').prop('disabled', false);
			});
