...
class Config extends Secure_area 
{
	...
	curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
      ...
      curl_close($ch);		
		...
		'user_configured_estimate_name' => $this->input->post('user_configured_estimate_name'),
		...
		'allow_employees_to_use_2fa' => $this->input->post('allow_employees_to_use_2fa') ? 1 : 0,
		...
		'require_customer_for_sale_by_payment' => $this->input->post('require_customer_for_sale_by_payment') ? 1 : 0,
		'require_customer_for_sale_by_payment_type' => $this->input->post('require_customer_for_sale_by_payment_type'),
		...
		'hide_supplier_in_item_search_result' => $this->input->post('hide_supplier_in_item_search_result') ? 1 : 0,
		...
		'qr_code_format' => $this->input->post('qr_code_format'),
		...
		'disable_signature_capture_on_terminal_for_phppos_credit_card_processing' => $this->input->post('disable_signature_capture_on_terminal_for_phppos_credit_card_processing') ? 1 : 0,
		'capture_internal_notes_during_receiving' => $this->input->post('capture_internal_notes_during_receiving') ? 1 : 0,
		'default_employee_for_deliveries' => $this->input->post('default_employee_for_deliveries'),
		'disable_verification_for_qr_codes' => $this->input->post('disable_verification_for_qr_codes') ? 1 : 0,
		'disable_variation_popup_in_receivings' => $this->input->post('disable_variation_popup_in_receivings') ? 1 : 0,
		'hide_location_name_on_receipt' => $this->input->post('hide_location_name_on_receipt') ? 1 : 0,
		'allow_reorder_sales_receipt' => $this->input->post('allow_reorder_sales_receipt') ? 1 : 0,
		'allow_reorder_receiving_receipt' => $this->input->post('allow_reorder_receiving_receipt') ? 1 : 0,
		'disable_discount_by_percentage' => $this->input->post('disable_discount_by_percentage') ? 1 : 0,
		'use_main_image_as_default_image_in_e_commerce' => $this->input->post('use_main_image_as_default_image_in_e_commerce') ? 1 : 0,
		'disable_discounts_percentage_per_line_item' => $this->input->post('disable_discounts_percentage_per_line_item') ? 1 : 0,
		'create_invoices_for_customer_store_account_charges' => $this->input->post('create_invoices_for_customer_store_account_charges') ? 1 : 0,
		'create_invoices_for_supplier_store_account_charges' => $this->input->post('create_invoices_for_supplier_store_account_charges') ? 1 : 0,
		'turn_on_review_requests' => $this->input->post('turn_on_review_requests') ? 1 : 0,
		'send_sms_via_whatsapp' => $this->input->post('send_sms_via_whatsapp') ? 1 : 0,
		'additional_appointment_note' => $this->input->post('additional_appointment_note'),
		'number_of_decimals_displayed_on_sales_interface' => $this->input->post('number_of_decimals_displayed_on_sales_interface'),
		'payvantage' => $this->input->post('payvantage') ? 1 : 0,
		'easy_item_clone_button' => $this->input->post('easy_item_clone_button') ? 1 : 0,
		'customer_allow_partial_match' => $this->input->post('customer_allow_partial_match') ? 1 : 0,
		
		'enable_ig_integration' => $this->input->post('enable_ig_integration') ? 1 : 0,
		'ig_api_bearer_token' => $this->input->post('ig_api_bearer_token') ? $this->input->post('ig_api_bearer_token') : '',

		'enable_wgp_integration' => $this->input->post('enable_wgp_integration') ? 1 : 0,
		'wgp_integration_pkey' => $this->input->post('wgp_integration_pkey') ? $this->input->post('wgp_integration_pkey') : '',
		'wgp_integration_userid' => $this->input->post('wgp_integration_userid') ? $this->input->post('wgp_integration_userid') : '',
		'work_order_notes_internal' => $this->input->post('work_order_notes_internal') ? 1 : 0,
		'work_repair_item_taxable' => $this->input->post('work_repair_item_taxable') ? 1 : 0,
		'enable_p4_integration' => $this->input->post('enable_p4_integration') ? 1 : 0,
		'p4_api_bearer_token' => $this->input->post('p4_api_bearer_token') ? $this->input->post('p4_api_bearer_token') : '',

		'enable_quick_customers' 	=> $this->input->post('enable_quick_customers') ? $this->input->post('enable_quick_customers') : '',
		'enable_quick_suppliers' 	=> $this->input->post('enable_quick_suppliers') ? $this->input->post('enable_quick_suppliers') : '',
		'enable_quick_items' 		=> $this->input->post('enable_quick_items') ? $this->input->post('enable_quick_items') : '',
		...
		'sso_protocol' => $this->input->post('sso_protocol'),
		'only_allow_sso_logins' => $this->input->post('only_allow_sso_logins') ? 1 : 0,

		'saml_idp_entity_id' => $this->input->post('saml_idp_entity_id'),
		'saml_name_id_format' => $this->input->post('saml_name_id_format'),
		'saml_first_name_field' => $this->input->post('saml_first_name_field'),
		'saml_last_name_field' => $this->input->post('saml_last_name_field'),
		'saml_email_field' => $this->input->post('saml_email_field'),
		'saml_groups_field' => $this->input->post('saml_groups_field'),
		'saml_locations_field' => $this->input->post('saml_locations_field'),
		...
		'oidc_cert_url' => $this->input->post('oidc_cert_url'),
		'oidc_username_field' => $this->input->post('oidc_username_field'),
		'oidc_groups_field' => $this->input->post('oidc_groups_field'), 
		'oidc_locations_field' => $this->input->post('oidc_locations_field'),
		'oidc_additional_scopes' => $this->input->post('oidc_additional_scopes'),
		'add_ck_editor_to_item' => $this->input->post('add_ck_editor_to_item') ? 1 : 0,
		...
		'hide_repair_items_in_sales_interface' => $this->input->post('hide_repair_items_in_sales_interface') ? 1 : 0,
		'hide_repair_items_on_receipt' => $this->input->post('hide_repair_items_on_receipt') ? 1 : 0,
		'update_base_cost_price_from_units' => $this->input->post('update_base_cost_price_from_units') ? 1 : 0,
		'enable_name_prefix' => $this->input->post('enable_name_prefix') ? 1 : 0,
		'create_work_order_for_customer' => $this->input->post('create_work_order_for_customer') ? 1 : 0,
		'default_tech_is_logged_employee' => $this->input->post('default_tech_is_logged_employee') ? 1 : 0,
		'override_employee_label_on_receipt' => $this->input->post('override_employee_label_on_receipt'),
		'remove_weight_from_receipt' 		=> $this->input->post('remove_weight_from_receipt') ? 1 : 0,
		'show_item_description_service_tag' => $this->input->post('show_item_description_service_tag') ? 1 : 0,
		'show_phone_number_service_tag' 	=> $this->input->post('show_phone_number_service_tag') ? 1 : 0,
		'change_work_order_status_from_sales' => $this->input->post('change_work_order_status_from_sales') ? 1 : 0,
		'work_order_status_on_complete'	=> $this->input->post('work_order_status_on_complete'),
	...
	if($this->input->post('shopify_private'))
	{
	...
	//Old way of doing taxes; we handle this case
		...
		if (is_on_demo_host())
		{
			...
			$batch_save_data['company_logo'] = 0;
			$batch_save_data['company'] = $this->config->item('branding_name');
