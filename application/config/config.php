...
|--------------------------------------------------------------------------
|
| Enable/Disable global profiling for the application
|
|
|
|
*/
$config['enable_profiling'] = isset($_SERVER['CI_PROFILING']) && $_SERVER['CI_PROFILING'] ? TRUE : FALSE ;
...
if (isset($_SERVER['CI_BRANDING']))
{
	$brand = $_SERVER['CI_BRANDING'];
}
elseif(isset($_SERVER['HTTP_HOST']) && (strpos($_SERVER['HTTP_HOST'],'phppointale.com') !== FALSE || strpos($_SERVER['HTTP_HOST'],'phppos.com') !== FALSE || strpos($_SERVER['HTTP_HOST'],'phppointofsalestaging.com') !== FALSE))
{
